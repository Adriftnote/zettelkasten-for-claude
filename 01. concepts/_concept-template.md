...
| `different_from` | 대비되는 개념 | `- different_from [[parser]] (파서와 역할 다름)` |
| `extends` | 확장/발전 | `- extends [[ascii]] (ASCII를 확장함)` |
| `part_of` | 구성요소 | `- part_of [[unicode]] (Unicode의 구현체)` |
| `depends_on` | 의존성 | `- depends_on [[runtime]] (런타임 필요)` |
...
| `hub` | 허브 연결 | `- hub [[programming-basics]] (소속 허브)` |
