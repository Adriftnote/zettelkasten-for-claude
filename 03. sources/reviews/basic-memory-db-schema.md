...
permalink: 03.-sources/reviews/basic-memory-db-schema
---
...
Windows: C:\Users\{사용자}\.basic-memory\memory.db
```
...
- DB 파일 직접 접근: `sqlite3 ~/.basic-memory/memory.db`
- 스키마 확인: `.schema` 명령어
- 인덱스 확인: `.indexes`
...
- [[Three-Layer Memory Architecture|3계층 메모리 아키텍처]] - 이 스키마를 활용한 LTM 구현
- [[KGGen 이해 - 명사 통합과 동사 관계|KGGen 이해]] - 유사한 entity/relation 구조
- [[basic-memory-relation-customization|관계(Relation) 커스터마이징 가이드]] - relation_type 자유 정의 방법