...
> [!abstract] 개요
> [[Category Theory (카테고리 이론)|Category Theory for Programmers]]를 Rust로 배우는 체계적 가이드
...
## Part One: 기초 (19-197페이지) ^part-one
...
**프로젝트 적용:**
- [[Middleware (미들웨어)|미들웨어 체인]] (Axum의 Layer)
- 함수형 파이프라인 설계
...
**핵심 개념:**
- [[Type System과 Category Theory|타입 시스템의 중요성]] - 타입 = Object, 함수 = Morphism
- [[Pure Function과 Side Effect|Pure Functions]] - 같은 입력 → 같은 출력, 부작용 없음
- [[Pure Function과 Side Effect#Kleisli Category|Kleisli Categories]] - 부작용을 타입으로 포장
...
**핵심 개념:**
- [[Simple Graph와 Category Theory의 연결|Simple Graphs]] - 카테고리의 뼈대, 그래프 이론에서 옴
- [[Order와 Relation의 계층|Orders]] (preorder, partial order) - 조건을 만족하는 relation
- [[Monoid와 비가환 구조|Monoid as Category]] - 하나의 Object를 가진 카테고리
...
## Part Two: 선언적 프로그래밍 (197-271) ^part-two
...
## Part Three: 고급 주제 (271-491) ^part-three
...
> - [[03-development-roadmap|개발단계별 로드맵]] - 프로젝트 단계와 매핑
> - [[README|전체 가이드 개요]] - README

> [!tip] 관련 개념
> - [[Category Theory (카테고리 이론)]] - 수학적 배경과 프로그래밍 연결
> - [[Knowledge Graph (지식 그래프)]] - 카테고리 이론과 구조적 유사성
> - [[Middleware (미들웨어)]] - 함수 합성의 실용적 예시 (Ch.1 프로젝트 적용)
