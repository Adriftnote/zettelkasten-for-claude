...
- connects_to [[웹 기초 (Web Fundamentals)]] (웹은 UTF-8이 표준)
- connects_to [[프로그래밍 기초 (Programming Basics)]] (소스 코드 파일도 인코딩 필요)
- connects_to [[메모리 시스템 (Memory Systems)]] (메모리에 문자 저장 방식)
