...
- extends [[프로그래밍 기초 (Programming Basics)]] (언어별 상세 비교 추가)
- connects_to [[Rust 언어 완전 가이드 (Rust Language Guide)]] (Rust 심화 가이드)
- connects_to [[MCP Tool 패턴 (MCP Tool Patterns)]] (TypeScript로 MCP 서버 개발)
- organizes [[DSL (Domain-Specific Language)]] (6. 도메인 특화 언어 개념)
- organizes [[범용 프로그래밍 언어 (General-Purpose Language)]] (7. 범용 언어 개념)
- connects_to [[프로그래밍 패러다임 (Programming Paradigms)]] (각 언어의 패러다임 분류)
