...
- [insight] 최적화의 3대 축: 비용, 속도, 안정성 #optimization #performance
- [insight] 토큰 절감 > KV 캐시 활용 > 장애 복구 순서로 우선순위 설정 #token #strategy
- [insight] 토큰은 돈이다 - 같은 결과를 더 적은 토큰으로 얻는 것이 핵심 #cost
- [tip] 작은 개선의 적립: 1% 절감 × 100회 = 거대한 효율 향상 #tip
- [path] 기초 개념 (비용 인식) → 토큰 최적화 → KV 캐시 활용 → 안정성 구축 #learning
