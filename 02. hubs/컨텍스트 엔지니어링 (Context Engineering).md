...
- connects_to [[최적화 패턴 (Optimization Patterns)]] (토큰 최적화 전략과 연결)
- connects_to [[MCP Tool 패턴 (MCP Tool Patterns)]] (도구 사용 시 컨텍스트 관리)
- connects_to [[아키텍처 (Architectures)]] (에이전트 아키텍처의 컨텍스트)