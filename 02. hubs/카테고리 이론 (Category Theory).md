...
- connects_to [[Rust 언어 완전 가이드 (Rust Language Guide)]] (Rust 언어 허브)
- connects_to [[프로그래밍 기초 (Programming Basics)]] (타입 시스템, 컴파일러 기초)
- connects_to [[AI-ML 개념 (AI-ML Concepts)]] (Attention과 함수 합성)
- connects_to [[아키텍처 (Architectures)]] (미들웨어 = 함수 합성)
