...
- connects_to [[메모리 시스템 (Memory Systems)]] (데이터 구조가 저장되는 메모리 계층)
- connects_to [[프로그래밍 기초 (Programming Basics)]] (데이터 구조를 활용하는 알고리즘/코드)
- connects_to [[최적화 패턴 (Optimization Patterns)]] (캐시 친화성, 성능 최적화)
